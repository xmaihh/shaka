...
public class MultiRadioGroupAuto extends RadioGroup {
    public MultiRadioGroupAuto(Context context) {
        super(context);
    }

    public MultiRadioGroupAuto(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
